...
def main():
    parser = argparse.ArgumentParser(description="Split evaluation JSON data into per-GPU shards.")
    parser.add_argument("--input_path", required=True, help="Input JSON file path.")
    parser.add_argument("--output_path", required=True, help="Output directory for shard files.")
