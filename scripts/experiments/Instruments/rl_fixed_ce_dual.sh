...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/rl_outputs/Instruments-grec-genrec-fixed-ce-dual-from-sft}"
RUN_NAME="${RUN_NAME:-instruments_grec_genrec_fixed_ce_dual_from_sft}"
