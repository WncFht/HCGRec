...
DATASET_SUBDIR="${DATASET_SUBDIR:-Arts_grec_index}"
DATASET_KEY_PREFIX="${DATASET_KEY_PREFIX:-Arts_grec_index}"
OUTPUT_DIR="${OUTPUT_DIR:-${GENREC_ROOT}/data/Arts_grec_index}"
SEQ_SAMPLE="${SEQ_SAMPLE:-10000}"
TASK3_SAMPLE="${TASK3_SAMPLE:-100000}"
...
exec env "${PREPARE_ENV[@]}" \
  bash "${REPO_ROOT}/scripts/experiments/Arts/prepare_arts_grec_lcrec_aligned_data.sh" \
  "$@"
